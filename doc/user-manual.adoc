...
= Acquia Lift Anypoint™ Connector

Anypoint™ Connector for connecting with the Hybris Platform Web Services.
...
It should contain a working fully functionaly Mule application as a demo, where the use case is considered. The demo needs to be simple and only considering a single use case.
